 ...
 */
final class Version20241230133626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artist_playlist (artist_id INT NOT NULL, playlist_id INT NOT NULL, PRIMARY KEY(artist_id, playlist_id))');
        $this->addSql('CREATE INDEX IDX_6F88FB7CB7970CF8 ON artist_playlist (artist_id)');
        $this->addSql('CREATE INDEX IDX_6F88FB7C6BBD148 ON artist_playlist (playlist_id)');
        $this->addSql('ALTER TABLE artist_playlist ADD CONSTRAINT FK_6F88FB7CB7970CF8 FOREIGN KEY (artist_id) REFERENCES artist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE artist_playlist ADD CONSTRAINT FK_6F88FB7C6BBD148 FOREIGN KEY (playlist_id) REFERENCES playlist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist_playlist DROP CONSTRAINT FK_6F88FB7CB7970CF8');
        $this->addSql('ALTER TABLE artist_playlist DROP CONSTRAINT FK_6F88FB7C6BBD148');
        $this->addSql('DROP TABLE artist_playlist');
    }
}
