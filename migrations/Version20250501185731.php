 ...
 */
final class Version20250501185731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        */
        $this->addSql('ALTER TABLE artist ADD profile_pic VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist DROP profile_pic');
    }
}
