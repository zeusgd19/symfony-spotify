 ...
 */
final class Version20250116182427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        */
        $this->addSql('ALTER TABLE artist ADD email VARCHAR(180) NOT NULL');
        $this->addSql('ALTER TABLE artist ADD roles JSON NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL ON artist (email)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist DROP roles');
    }
}
