 ...
 */
final class Version20250505143750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        */
        $this->addSql('ALTER TABLE artist ADD refresh_token VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist DROP refresh_token');
    }
}
