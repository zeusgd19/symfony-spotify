 ...
 */
final class Version20250505144951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        */
        $this->addSql('ALTER TABLE artist DROP access_token');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist ADD access_token VARCHAR(255) DEFAULT NULL');
    }
}
