 ...
 */
final class Version20241220110708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        */
        ...
        $this->addSql('CREATE TABLE playlist (id INT NOT NULL, album_id INT NOT NULL, title VARCHAR(255) NOT NULL, cover TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D782112D1137ABCF ON playlist (album_id)');
        $this->addSql('CREATE TABLE song (id INT NOT NULL, album_id INT NOT NULL, title VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE playlist ADD CONSTRAINT FK_D782112D1137ABCF FOREIGN KEY (album_id) REFERENCES album (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE playlist DROP CONSTRAINT FK_D782112D1137ABCF');
